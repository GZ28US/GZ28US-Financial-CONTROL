    ...
    <main className="min-h-screen bg-black text-white p-8">
      ...
      <div className="max-w-2xl">
        ...
        <div className="border border-gray-800 rounded-2xl overflow-hidden">
          ...
          <Row label="(−) Compras a atribuir" value={-m.bucket} sub k="bucket" note="conta de suspensão: o banco pagou, o carro ainda não foi dito — fora de toda margem por job; a fila A ATRIBUIR do Bank Link esvazia esta linha. Atribuir a um CARRO move o custo pro CPV do job (reconhecido na conclusão) — as colunas por período mudam de propósito. Compra no cartão sem nota entra 7 dias depois da data do banco (AUTO-LINK fase B)" />
