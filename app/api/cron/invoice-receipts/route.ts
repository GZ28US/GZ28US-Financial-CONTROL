...
export async function GET(req: NextRequest) {
  ...
  // O ESPELHO DO CLIENTE SAIU DAQUI (11/set/2026). Este cron varria também as despesas
  // PAID FROM CLIENT pra criar item e renda espelhados — máquina do app do BR, que o
  // Márcio tirou do US («no app do US não é pra ter a opção do CLIENT, tire»). Ela
  // nunca gravou uma linha na vida: 0 de 804 items e 0 de 220 rendas com o elo.
  // Sobra o que este cron sempre existiu pra fazer: levar o RECIBO pra pasta da
  // invoice quando quem escreveu foi robô. Só a linha COM papel interessa.
