...
type Expense = { supplier: string; item: string; amount: string; quantity: string; payment_date: string; receipt_urls: string[]; purchase_group?: string }
...
export default function NewInvoicePage() {
  ...
  function removePurchaseGroup(groupItems: { index: number }[]) {
