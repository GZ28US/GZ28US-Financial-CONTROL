...
export const TAX_VERSION = '0.2.0'

export const TAX_CHANGELOG: { version: string; date: string; notes: string }[] = [
  { version: '0.2.0', date: '2026-08-23', notes: 'UNIR beneficiários: o banco trunca o mesmo nome de jeitos diferentes ("Nathan D Perez" / "NATHAN PERE", "Foss Motors" / "Foss Motors Ll") — agora cada linha tem UNIR… e o app ainda aponta os "PARECE O MESMO" sozinho (prefixo igual). O apelido some da lista, os totais somam no canônico, classificação e W-9 são absorvidos, tudo na trilha. Migration: MIGRATION_tax_1099_v2.sql (coluna aliases).' },
